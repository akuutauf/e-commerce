...
<section id="navbar">
    <nav class="navbar navbar-expand-md navbar-dark navbar-color fixed-top shadow-card  ">
        <div class="container d-flex justify-content-lg-around align-items-center">
            <a class="navbar-brand semi-bold" href="/">Obugami</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <form class="form-inline my-2 mx-auto search-bar">
                    <input id="search" class="form-control pl-5 medium secondary-color" size="50" type="search"
                ...
                <div id="icon-cart" class="mx-lg-5">
                    <a href="#"><i class="fa-solid fa-store text-white icon-size"></i></a>
                </div>
