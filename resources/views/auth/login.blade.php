                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    <input type="email" placeholder=" Username"
                                        class="form-control form-theme  @error('email') is-invalid @enderror"
                                        name="email" value="{{ old('email') }}" required autocomplete="email"
                                        autofocus id="exampleInputEmail1" aria-describedby="emailHelp">
                                ...
                                <div class="form-group mb-4">
                                    <input type="password"
                                        class="form-control form-theme @error('password') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-theme btn-lg btn-block border-none medium">
                                        {{ __('Login') }}
                                    </button>
                                </div>
