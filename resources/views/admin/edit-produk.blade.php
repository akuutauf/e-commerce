...
@section('title')
    <title>Obugami | Edit Produk</title>
@endsection
                ...
                <div class="row ml-4 mr-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-theme" id="varian-produk" name="varian-produk"
                                placeholder="Jenis Varian" value="Chocolate">
                        </div>
                    </div>
                </div>
                <div class="row ml-4 mr-4">
