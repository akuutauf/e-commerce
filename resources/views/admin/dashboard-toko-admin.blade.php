                        ...
                        <div class="col py-5 my-auto">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 my-auto">
                                    <h6 class="secondary-color font-10 nama-kota text-left">Banyuwangi <i
                                            class="fa-solid fa-location-dot color-theme"></i></h6>
                                </div>
                            </div>
                            <a href="/kelola-produk" class="btn btn-chat mt-2 medium">
                                Kelola Produk
                            </a>
                            <a href="/kelola-promo" class="btn btn-chat-2 mt-2 medium">
                                Kelola Promo
                            </a>
                        </div>
                    </div>
